 ...
 * @package    EcomCore_Freight
 */
class EcomCore_Freight_Helper_Australiapost extends Mage_Core_Helper_Data
{
    const XML_PATH_AUSTRALIA_POST_DEVELOPER_MODE = 'carriers/eccfreightpost/developer_mode';
    ...
    {
        return (bool)($value == EcomCore_Freight_Model_Shipping_Carrier_Australiapost_Source_Visibility::OPTIONAL);
    }
    ...
    {
        return $this->getCountryId() == EcomCore_Freight_Helper_Data::AUSTRALIA_COUNTRY_CODE;
    }
    ...
    {
        return Mage::getStoreConfig('carriers/eccfreightpost/active');
    }
     ...
     *
     * @return EcomCore_Freight_Model_Shipping_Carrier_Australiapost_Source_Visibility
     */
    public function getSignatureOnDelivery()
    {
        return Mage::getStoreConfig('carriers/eccfreightpost/signature_on_delivery');
    }
    ...
    {
        return Mage::getStoreConfig('carriers/eccfreightpost/extra_cover');
    }
    ...
    {
        return Mage::getStoreConfig('carriers/eccfreightpost/pick_up');
    }
    ...
    public function getAttribute(Mage_Shipping_Model_Rate_Request $request, $attribute)
    {
        ...
        $attributeCode = Mage::getStoreConfig('carriers/eccfreightpost/' . $attribute . '_attribute');
        if (!$attributeCode) {
            return Mage::getStoreConfig('carriers/eccfreightpost/default_' . $attribute);
        }
