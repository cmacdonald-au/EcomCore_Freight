...
class EcomCore_Freight_Model_Shipping_Carrier_Eparcel_Export_Csv extends EcomCore_Freight_Model_Shipping_Carrier_Common_Export_Csv_Abstract
{
    const ENCLOSURE = '"';
    const DELIMITER = ',';
     ...
     * @throws EcomCore_Freight_Model_Shipping_Carrier_Eparcel_Export_Exception
     */
    public function exportOrders($orders)
    {
        ...
        foreach ($orders as $order) {
            ...
            if (!$order->getShippingCarrier() instanceof EcomCore_Freight_Model_Shipping_Carrier_Eparcel) {
                throw new EcomCore_Freight_Model_Shipping_Carrier_Eparcel_Export_Exception(
