 ...
 * @package    EcomCore_Freight
 */
class EcomCore_Freight_Model_Payment_Bpay extends Mage_Payment_Model_Method_Abstract
{
    const CODE = 'bpay';

    protected $_code  = self::CODE;
    protected $_formBlockType = 'ecomcore_freight_block_bpay_form';
    protected $_infoBlockType = 'ecomcore_freight_block_bpay_info';
     ...
     *
     * @param mixed $data
     * @return EcomCore_Freight_Model_Payment_Bpay
     */
