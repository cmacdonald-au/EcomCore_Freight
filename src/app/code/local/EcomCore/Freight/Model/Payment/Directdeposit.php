 ...
 * @package    EcomCore_Freight
 */
class EcomCore_Freight_Model_Payment_Directdeposit extends Mage_Payment_Model_Method_Abstract
{
    const CODE = 'directdeposit_au';

    protected $_code  = self::CODE;
    protected $_formBlockType = 'EcomCore_Freight_Block_Directdeposit_Form';
    protected $_infoBlockType = 'EcomCore_Freight_Block_Directdeposit_Info';
     ...
     *
     * @param mixed $data
     * @return EcomCore_Freight_Model_Payment_Directdeposit
     */
