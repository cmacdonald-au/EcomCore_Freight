 ...
 */
class EcomCore_Freight_Model_Address_Config_Backend
{
    const AUSTRALIA_POST = 'eccfreight/address_eccfreightpost';
    ...
    public function toOptionArray()
    {
        return array(
            array(
                ...
                'label' => Mage::helper('eccfreight')->__('Australia Post Delivery Choices'),
            ),
        );
    }
}
