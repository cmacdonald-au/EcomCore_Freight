...
class EcomCore_Freight_Block_Directdeposit_Info extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('ecomcore/freight/payment/directdeposit/info.phtml');
    }
     ...
     *
     * @return EcomCore_Freight_Block_Directdeposit_Info
     */
