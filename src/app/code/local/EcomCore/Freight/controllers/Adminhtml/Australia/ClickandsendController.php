 ...
 * @package    EcomCore_Freight
 */
class EcomCore_Freight_Adminhtml_Australia_ClickandsendController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function exportAction()
    {
        ...
        try {
            ...
            $filePath = Mage::getModel('eccfreight/shipping_carrier_clickandsend_export_csv')->exportOrders($orders);
